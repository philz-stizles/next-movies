...
export const getMovies = (milliseconds) => {
...
export const createMovie = (movie, milliseconds) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            const newMovie = { id: Math.random().toString(36).substr(2, 7), ...movie }
            console.log(newMovie)
            MOVIE_DATA.unshift(newMovie)
            // or MOVIE_DATA.push(newMovie)
